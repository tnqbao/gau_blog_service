...
func DeleteDownvoteByBlogID(c *gin.Context) {
	...
	if err != nil {
		c.JSON(500, gin.H{"status": 500, "error": "Cannot delete downvote: " + err.Error()})
		return
	}

	c.JSON(200, gin.H{"status": 200, "message": "Delete downvote successfully!"})
}
